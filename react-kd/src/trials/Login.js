...
const Login =()=>{
    ...
    return(
        ...
        <div className="container p-3 mt-4 bg-dark shadow">
            ...
            <div className="col-md-6 mb-2 p-5 my-auto shadow bg-light text-dark">
                <div className="text-center mb-2 m">
                    <h5><b>Login</b></h5><hr />
        <form action="/action_page.php" onSubmit={submitData}>
        <div className="form-group">
        <input type="email" className="form-control" id="email" onChange={saveValue} placeholder="Enter username/@gmail.com"/>
        </div>
        <div className="form-group">
        <input type="password" className="form-control" id="pwd" onChange={savePass} placeholder="Enter password"/>
        </div>
        <div className="row">
            <div className="col">
